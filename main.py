...
if __name__ == '__main__':
    ...
    config = {"seed": 1, "batch_size": 8, "dir_base": directory_base, "epochs": 100, "n_classes": 2, "LR": 1e-3,
              "IMG_SIZE": 480, "train_samples": .8, "test_samples": .5, "data_path": "D:/candid_ptx/",
              "report_gen": False, "mlm_pretraining": False, "contrastive_training": False, "save_location": ""} #batch size was 8 with image size 256 .8 can use .004
    ...
    for seed in seeds:
        ...
        folder_name = "higher_res_for_paper/gloria_image_encoder_v36/seed" + str(seed) + "/"
