...
if __name__ == '__main__':
    ...
    config = {"seed": 1, "batch_size": 8, "dir_base": directory_base, "epochs": 3, "n_classes": 2, "LR": 1e-5,
              "IMG_SIZE": 512, "train_samples": .8, "test_samples": .5, "data_path": "D:/candid_ptx/", "report_gen":False, "mlm_pretraining":False, "pretraining":False}
