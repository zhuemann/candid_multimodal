...
if __name__ == '__main__':
    ...
    config = {"seed": 1, "batch_size": 4, "dir_base": directory_base, "epochs": 150, "n_classes": 2, "LR": 1e-3,
              "IMG_SIZE": 1024, "train_samples": .8, "test_samples": .5, "data_path": "D:/candid_ptx/",
              "report_gen": False, "mlm_pretraining": False, "contrastive_training": True, "save_location": ""} #batch size was 8 with image size 256
