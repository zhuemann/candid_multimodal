...
if __name__ == '__main__':
    ...
    config = {"seed": 1, "batch_size": 1, "dir_base": directory_base, "epochs": 150, "n_classes": 2, "LR": 1e-5,
              "IMG_SIZE": 256, "train_samples": .8, "test_samples": .5, "data_path": "D:/candid_ptx/", "report_gen":False, "mlm_pretraining":False, "contrastive_training": False}
    ...
    for seed in seeds:
        ...
        df = pd.DataFrame(valid_log)
        df["test_accuracy"] = acc
        folder_name = "multimodal_v13_without_att_baseline"
        # save to xlsx file
