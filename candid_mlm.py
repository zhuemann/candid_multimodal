...
def candid_fine_tuning_candid(dir_base="Z:/"):
    ...
    # tokenizer = AutoTokenizer.from_pretrained("/Users/zmh001/Documents/language_models/bio_clinical_bert/",
    # truncation=True)
    # tokenizer = AutoTokenizer.from_pretrained("Z:/Zach_Analysis/roberta/", truncation=True) bert =
    # AutoModelWithLMHead.from_pretrained("/Users/zmh001/Documents/language_models/bio_clinical_bert/") bert =
    # AutoModelWithLMHead.from_pretrained("/Users/zmh001/Documents/language_models/roberta_large/") bert =
    # AutoModelWithLMHead.from_pretrained("Z:/Zach_Analysis/roberta/")
    ...
    text_file = reports_file.replace('.csv', '.txt')  # get the data into correct format -- text blocks.
    ...
    # report_direct = 'Z:/Lymphoma_UW_Retrospective/Reports/' # get vocab needed to add
    vocab_file = ''
