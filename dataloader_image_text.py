...
class TextImageDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        text = "There is a right basal intercostal drainage tube and the large loculated hydropneumothorax along the periphery of the right middle and lower zones is again seen.  There is also a predominant left subpulmonary pleural fluid collection.  Remainder of lung fields clear of active disease.  (Slight pectus carinatum.)  Note that there are 3 air fluid levels relating to the loculated right basal pleural fluid collection."
