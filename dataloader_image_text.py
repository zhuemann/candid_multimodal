...
class TextImageDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        text = "on the right a loculated hydropneumothorax with an air fluid level in the peripheral right basal region.  There is generalised opacification of the right hemithorax.  The left-sided central venous line tip is situated in the superior vena cava. There is an air fluid level situated medial to the left sternoclavicular joint due to further hydropneumothorax."
