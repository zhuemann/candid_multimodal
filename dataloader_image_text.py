...
class TextImageDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        text = "There is a moderately-sized right lower zone pneumothorax persisting after the drainage.  There is extensive consolidation in the right lower lobe. Transcribed by: dh [PERSONALNAME] [PERSONALNAME]"
