...
class TextImageDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        text = "The heart size is at the upper limit of normal with signs of previous cardiac surgery with sternotomy wires and CABG clips. There is persistent left basal pleural effusion unchanged since the previous examination. The appearance is suspicious for a very small left apical pneumothorax similar to the previous examination."
