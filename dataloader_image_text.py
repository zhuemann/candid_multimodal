...
class TextImageDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        text = "There is a large pneumothorax.The mediastinum is shifted mildly.The lung appears normal.The heart size is within normal limits. No other abnormality is seen. Reported in consultation with Dr [PERSONALNAME]. Transcribed by:  wk Dr [PERSONALNAME]  Dr. [PERSONALNAME] [PERSONALNAME] "
